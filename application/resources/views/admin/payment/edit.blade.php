                                        ...
                                        <select class="form-control select2" id="three_month_month"
                                            ...
                                            @foreach($multiple_months as $month)
                                                <option value="{{ $month['value'] }}"
                                                        @if(old('three_month_month', $payment['three_month_month']) == $month['value']) selected @endif>{{ $month['name'] }}</option>
                                            @endforeach
                                        </select>
                                                ...
                                                <select class="form-control select2" id="item"
                                                    ...
                                                    @foreach($items as $item)
                                                        <option value="{{ $item['name'] }}"
                                                                @if($item['name'] == old('item.'.$key, $payment['items'][$key]['name'])) selected @endif>{{ $item['name'] }}</option>
                                                    @endforeach
                                                </select>
